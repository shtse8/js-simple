...
/*#__PURE__*/
function () {
  function DateTimeSimple(time) {
    (0, _classCallCheck2.default)(this, DateTimeSimple);
    this.moment = this.newMoment(time);
    this.format = 'YYYY-MM-DD HH:mm:ss';
  }

  (0, _createClass2.default)(DateTimeSimple, [{
    key: "newMoment",
...
exports.DateTimeSimple = DateTimeSimple;